        ...
        <div className="space-y-10">
          <section className="bg-[#17151C]/80 backdrop-blur-xl border border-[rgba(255,255,255,0.1)] rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg leading-relaxed">
              ...
              <a href="tel:+36705767845" className="text-[#F2A93B] hover:text-[#2DD4BF] underline transition-colors">
                +36 70 576 7845
              </a>
            </p>
          </section>
          ...
          <section className="bg-[#17151C]/80 backdrop-blur-xl border border-[rgba(255,255,255,0.1)] rounded-2xl p-8 md:p-10">
            ...
            <p className="text-white text-lg leading-relaxed">
              ...
              <a href="mailto:verdung.imi@gmail.com" className="text-[#F2A93B] hover:text-[#2DD4BF] underline transition-colors font-semibold">
                verdung.imi@gmail.com
              </a>{" "}
