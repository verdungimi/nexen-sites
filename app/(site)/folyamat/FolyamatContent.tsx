...
import { MessageCircle, Palette, CheckCircle2, Rocket } from "lucide-react";
...
export default function FolyamatContent() {
  return (
    <>
      {/* Hero Section */}
      <section className="min-h-[60vh] flex items-center justify-center relative pt-32 pb-12 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10" style={{ pointerEvents: 'auto' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-12">
            {[
              { step: "01", title: "Konzultáció", icon: MessageCircle },
              { step: "02", title: "Tervezés", icon: Palette },
              { step: "03", title: "Tesztelés", icon: CheckCircle2 },
              { step: "04", title: "Indítás", icon: Rocket },
            ].map((item, index) => (
              <div key={index} className="bg-[#17151C]/50 backdrop-blur-sm border border-[rgba(255,255,255,0.1)] rounded-xl p-4 text-center hover:border-[#2DD4BF]/50 transition-all">
                <item.icon className="w-6 h-6 mb-2 mx-auto text-[#2DD4BF]" strokeWidth={1.75} />
            ...
            <div className="grid md:grid-cols-4 gap-6 md:gap-8 relative">
              {[
                ...
                >
                  ...
                  <process.icon className="w-9 h-9 mb-3 mx-auto text-[#F2A93B]" strokeWidth={1.5} />
