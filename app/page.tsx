      ...
      <section className="min-h-screen flex items-center justify-center relative pt-24 pb-16 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10" style={{ pointerEvents: 'auto' }}>
          <div className="text-center max-w-5xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-8 leading-[0.95] tracking-tight" style={{ fontFamily: 'var(--font-space-grotesk), sans-serif' }}>
            ...
            {/* Subheadline - Minimal */}
            <p className="text-lg md:text-xl lg:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto font-light leading-relaxed animate-fade-in-delay-2" style={{ fontFamily: 'var(--font-space-grotesk), sans-serif' }}>
            ...
            <div className="group relative bg-[#0F1620]/90 backdrop-blur-xl border-2 border-[rgba(237,80,150,0.3)] rounded-3xl p-8 md:p-10 transition-all duration-500 hover:border-[#ED5096] shadow-[0_0_25px_rgba(237,80,150,0.25)] hover:shadow-[0_0_45px_rgba(237,80,150,0.5)] hover:-translate-y-2">
              ...
              <div className="relative z-10">
                ...
                <div className="pt-4 border-t border-[rgba(255,255,255,0.1)]">
                  <div className="mb-3">
                    <span className="inline-block px-3 py-1 bg-gradient-to-r from-[#ED5096] to-[#ED5096]/80 text-white text-xs font-bold rounded-lg">
                      Megoldás:
                    </span>
                  </div>
