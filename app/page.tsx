    ...
    <>
      ...
      <Section id="contact">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-8 inline-flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-[#ED5096]/20 via-[#ED5096]/30 to-[#ED5096]/20 border-2 border-[#ED5096] rounded-xl shadow-[0_0_30px_rgba(237,80,150,0.4)] animate-pulse">
            <div className="flex items-center gap-2">
              <svg className="w-6 h-6 text-[#ED5096] animate-bounce" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
              <span className="text-white font-bold text-lg">
                ⚠️ Ebben a hónapban már csak <span className="text-[#ED5096] text-2xl font-black">3 hely</span> maradt!
              </span>
            </div>
          </div>
        </div>
