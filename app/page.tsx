      ...
      <section className="min-h-screen flex items-center justify-center relative pt-24 pb-16 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10" style={{ pointerEvents: 'auto' }}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative w-24 h-24 rounded-2xl border-2 border-[#50AEDF] bg-[rgba(80,174,223,0.1)] shadow-[0_0_20px_rgba(80,174,223,0.5)] flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full text-[#50AEDF] opacity-30" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                <h3 className="relative text-xs font-bold text-[#50AEDF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(80,174,223,0.8)]">Mobilbarát</h3>
              </div>
              <div className="relative w-24 h-24 rounded-2xl border-2 border-[#7C5CFF] bg-[rgba(124,92,255,0.1)] shadow-[0_0_20px_rgba(124,92,255,0.5)] flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full text-[#7C5CFF] opacity-30" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <h3 className="relative text-xs font-bold text-[#7C5CFF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(124,92,255,0.8)]">Gyors betöltés</h3>
              </div>
            </div>
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative w-24 h-24 rounded-2xl border-2 border-[#7C5CFF] bg-[rgba(124,92,255,0.1)] shadow-[0_0_20px_rgba(124,92,255,0.5)] flex items-center justify-center">
                ...
                <h3 className="relative text-xs font-bold text-[#7C5CFF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(124,92,255,0.8)]">SEO kész</h3>
              </div>
              <div className="relative w-24 h-24 rounded-2xl border-2 border-[#50AEDF] bg-[rgba(80,174,223,0.1)] shadow-[0_0_20px_rgba(80,174,223,0.5)] flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full text-[#50AEDF] opacity-30" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 className="relative text-xs font-bold text-[#50AEDF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(80,174,223,0.8)]">24/7 támogatás</h3>
              </div>
            </div>
          </div>
        </div>
