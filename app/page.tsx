          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative flex items-center justify-center w-24 h-24">
                <div className="absolute inset-0 rounded-2xl border-2 border-[#50AEDF] bg-[rgba(80,174,223,0.1)] shadow-[0_0_20px_rgba(80,174,223,0.5)]"></div>
                <svg className="relative w-16 h-16 text-[#50AEDF] drop-shadow-[0_0_10px_rgba(80,174,223,0.8)]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                <h3 className="absolute bottom-0 translate-y-full mt-2 text-xs font-bold text-white text-center whitespace-nowrap">Mobilbarát</h3>
              </div>
              <div className="relative flex items-center justify-center w-24 h-24">
                <div className="absolute inset-0 rounded-2xl border-2 border-[#7C5CFF] bg-[rgba(124,92,255,0.1)] shadow-[0_0_20px_rgba(124,92,255,0.5)]"></div>
                <svg className="relative w-16 h-16 text-[#7C5CFF] drop-shadow-[0_0_10px_rgba(124,92,255,0.8)]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <h3 className="absolute bottom-0 translate-y-full mt-2 text-xs font-bold text-white text-center whitespace-nowrap">Gyors betöltés</h3>
              </div>
            </div>
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative flex items-center justify-center w-24 h-24">
                ...
                <h3 className="absolute bottom-0 translate-y-full mt-2 text-xs font-bold text-white text-center whitespace-nowrap">SEO kész</h3>
              </div>
              <div className="relative flex items-center justify-center w-24 h-24">
                <div className="absolute inset-0 rounded-2xl border-2 border-[#50AEDF] bg-[rgba(80,174,223,0.1)] shadow-[0_0_20px_rgba(80,174,223,0.5)]"></div>
                <svg className="relative w-16 h-16 text-[#50AEDF] drop-shadow-[0_0_10px_rgba(80,174,223,0.8)]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                ...
                <h3 className="absolute bottom-0 translate-y-full mt-2 text-xs font-bold text-white text-center whitespace-nowrap">24/7 támogatás</h3>
              </div>
            </div>
          </div>
        </div>
