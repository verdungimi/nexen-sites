          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative flex items-center justify-center">
                <svg className="w-20 h-20 text-[#50AEDF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                <h3 className="absolute text-xs font-bold text-white text-center whitespace-nowrap">Mobilbarát</h3>
              </div>
              <div className="relative flex items-center justify-center">
                <svg className="w-20 h-20 text-[#7C5CFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <h3 className="absolute text-xs font-bold text-white text-center whitespace-nowrap">Gyors betöltés</h3>
              </div>
            </div>
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative flex items-center justify-center">
                ...
                <h3 className="absolute text-xs font-bold text-white text-center whitespace-nowrap">SEO kész</h3>
              </div>
              <div className="relative flex items-center justify-center">
                <svg className="w-20 h-20 text-[#50AEDF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 className="absolute text-xs font-bold text-white text-center whitespace-nowrap">24/7 támogatás</h3>
              </div>
            </div>
          </div>
        </div>
