          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative flex items-center justify-center w-32 h-32">
                ...
                <h3 className="relative z-10 text-sm font-bold text-[#50AEDF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(80,174,223,0.8)]">Mobilbarát</h3>
              </div>
              <div className="relative flex items-center justify-center w-32 h-32">
                ...
                <h3 className="relative z-10 text-sm font-bold text-[#7C5CFF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(124,92,255,0.8)]">Gyors betöltés</h3>
              </div>
            </div>
            ...
            <div className="hidden lg:block lg:col-span-3 space-y-8 flex flex-col justify-center">
              <div className="relative flex items-center justify-center w-32 h-32">
                ...
                <h3 className="relative z-10 text-sm font-bold text-[#7C5CFF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(124,92,255,0.8)]">SEO kész</h3>
              </div>
              <div className="relative flex items-center justify-center w-32 h-32">
                <svg className="absolute inset-0 w-full h-full text-[#50AEDF] drop-shadow-[0_0_20px_rgba(80,174,223,0.8)]" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 className="relative z-10 text-sm font-bold text-[#50AEDF] text-center whitespace-nowrap drop-shadow-[0_0_10px_rgba(80,174,223,0.8)]">24/7 támogatás</h3>
              </div>
            </div>
          </div>
        </div>
