...
export default function TestimonialCard({ name, business, testimonial, result }: TestimonialCardProps) {
  return (
    <div className="card-hover bg-[#17151C] border border-[rgba(255,255,255,0.1)] p-8 rounded-2xl shadow-lg h-full relative overflow-hidden group hover:border-[#F2A93B]/50 hover:shadow-[0_0_30px_rgba(242,169,59,0.3)] transition-all duration-300">
      ...
      <div className="relative z-10">
        <div className="mb-4">
          <svg className="w-8 h-8 text-[#F2A93B] group-hover:text-[#2DD4BF] transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-4">
          <p className="font-semibold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[#F2A93B] group-hover:to-[#2DD4BF] transition-all duration-300 drop-shadow-md">{name}</p>
